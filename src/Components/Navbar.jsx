            ...
            <div className='container flex items-center justify-between'>
                <a className='text-xl font-bold text-primary flex items-center' href='#hero'>
                    <span className='relative z-10'>
                        <span className='text-glow text-foreground'>Vlasta Vašut</span>&nbsp;Porfolio
                    </span>
                </a>
                ...
                <button onClick={()=>setIsMenuOpened(!isMenuOpened)} className='flex md:hidden p-2 text-foreground z-50'
